...
#define IMU_ADDRESS 0x6B    //Change to the address of the IMU, was 68
...
int  err = IMU.setGyroRange(500);      //USE THESE TO SET THE RANGE, IF AN INVALID RANGE IS SET IT WILL RETURN -1
